...
emag: $(BUILD)/field2.o $(BUILD)/main.o $(BUILD)/pml.o $(BUILD)/field.o $(BUILD)/tfsf.o $(BUILD)/object.o $(BUILD)/source.o $(BUILD)/h5out.o $(BUILD)/monitor.o
	$(CXX) -std=c++11 -O2 $(BUILD)/field2.o $(BUILD)/main.o $(BUILD)/pml.o $(BUILD)/tfsf.o $(BUILD)/field.o $(BUILD)/object.o $(BUILD)/source.o $(BUILD)/h5out.o $(BUILD)/monitor.o -o emag
...
$(BUILD)/main.o: main.cc field2.cc
...
$(BUILD)/monitor.o: monitor.cc field2.cc
